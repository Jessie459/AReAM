...
if __name__ == "__main__":
    ...
    parser.add_argument("--list_path", default="data/voc/train_aug.txt", type=str)
    ...
    pyutils.Logger(os.path.join(args.save_path, "train.log"))
    ...
    for ep in range(args.num_epochs):
        ...
        torch.save(model.module.state_dict(), os.path.join(save_path, "checkpoint.pth"))
