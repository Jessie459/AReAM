...
import voc12.data
from tool import imutils, pyutils, torchutils
...
if __name__ == "__main__":
    ...
    train_dataset = voc12.data.VOC12AffDataset(
        ...
        radius=5,
        joint_transform_list=[None, None, imutils.RandomCrop(args.crop_size), imutils.RandomHorizontalFlip()],
        img_transform_list=[
        ...
        label_transform_list=[None, None, None, imutils.AvgPool2d(8)],
    )
            ...
            avg_meter.add(
                {
                    ...
                    "bg_cnt": bg_count.item(),
                    "fg_cnt": fg_count.item(),
                    "neg_cnt": neg_count.item(),
                }
            )
